						...
						<div class='py-6'>
							<div class=' relative flex flex-col md:flex-row justify-center items-center  max-w-xl min-w-min bg-white overflow-hidden'>
								...
								<div class='w-2/3 p-4'>
									...
									<p class='mt-2  text-base text-center md:text-left md:text-base'>Genre: {data[0].genres[0].name}</p>
									...
									<div class='mt-6 flex flex-col justify-center px-4 py-2 bg-white border border-gray-300 rounded'>
										<div>
											<p
												...
												{data[0].rating.toFixed(0) === "0"
													? "NR"
													: data[0].rating.toFixed(0)}
												%
											</p>

											<div className='flex items-center justify-center md:justify-start leading-tight mt-2 '>
												<span
													className={
