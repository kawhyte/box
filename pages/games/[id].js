				...
				<div className=' mx-auto z-10 max-w-screen-xl -mt-32'>
					<section className='pb-8 md:pb-20 bg-bgcolor '>
						<div className='container  mx-auto px-4'>
								...
								<div className=' relative flex flex-col md:flex-row justify-center items-center  max-w-3xl min-w-min bg-white overflow-hidden'>
									<img
									...
									<div className='md:mt-6 flex flex-col justify-center  '>
									<p className='mt-4 mr-2 mb-3 hidden md:block   text-base text-center md:text-left md:text-base'>
										Rating 	<span className="text-xl  text-left font-medium bg-green-500 text-textwhite p-1 rounded-lg ">{data[0].rating && data[0].rating.toFixed(0)
											? data[0].rating.toFixed(0) 
											: "Not Rated"}</span>
									</p>
												<div className='flex items-center  leading-tight mt-2 '>
													<span
														className={
													...
													<span
														...
														<p
															className={
																"px-2 text-sm mt-2 text-gray-100  " +
																outstanding
															}>
															Gold
														</p>
