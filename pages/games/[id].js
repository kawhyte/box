	...
	return (
		<>
			<main>
				...
				<section className='pb-20 bg-bgcolor  -mt-32  '>
					<div className='container mx-auto px-4'>
						<div class='py-6'>
							<div class=' relative bg-bgcolor flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden'>
								<img
									class='w-3/6 bg-cover'
									src={data.background_image}></img>

								<div class='w-2/3 p-4'>
									<p class='text-textwhite font-bold text-2xl'>{data.name}</p>
						...
						<div className='flex flex-wrap   items-center '>
							<div className='w-full md:w-6/12 px-4 mr-auto ml-auto mb-12 md:mb-0'>
								<h3 className='text-3xl text-textwhite mb-2 font-semibold leading-normal'>
									Description
								</h3>
							...
							<div className='w-full md:w-4/12 px-4 mr-auto ml-auto'>
								<div className='relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-600'>
									...
									<blockquote className='relative p-8 mb-4'>
										<h4 className='text-xl text-textwhite font-bold '>
										...
										<div className='flex'>
											...
											<div className='flex items-center justify-start leading-tight'>
												...
												<span
													...
													<p
														className={
															"px-2 text-xs mt-2 text-gray-400  " + outstanding
														}>
														Outstanding
													</p>
												</span>
