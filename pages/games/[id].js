                                ...
                                <div class=' relative bg-bgcolor flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden'>
									...
									<div  class="mt-6 flex flex-col justify-center px-4 py-2 bg-white border border-gray-300 rounded">
										<div>
											...
											<div className='flex items-center justify-start leading-tight mt-2'>
                                                        <span
                                                            className={
                                                                "py-2 px-2 items-center mr-2 flex flex-col  " + must_play
                                                        ...
                                                        <span
                                                            className={
                                                                "rounded items-center mr-2 text-gray-100 flex flex-col " + outstanding
                                                        ...
                                                        <span
                                                            className={
                                                                "rounded p-2   items-center mr-2 text-gray-100 flex flex-col " + skip
                                                        ...
                                                        <span
                                                            className={
                                                                "items-center mr-2 text-gray-100 flex flex-col " + try_it
