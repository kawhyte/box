		...
		<>
			<section className='text-gray-600 body-font  container max-w-6xl '>
				<div className=' mx-auto flex px-5 items-center justify-center flex-col'>
					...
					<div className='text-center  w-full  -mt-24  flex flex-col  justify-center z-20 '>
						<span className='text-right rotate-90  opacity-20    z-20 top-0 right-0 '>
							{" "}
							{games[randomNum].name}
						</span>
