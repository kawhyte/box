...
function Welcome() {
	return (
		<div className='container flex	flex-col justify-center  bg-accentColor text-textwhite text-center py-8 rounded-xl my-3 mt-48 max-w-md  md:max-w-xl lg:max-w-7xl '>
